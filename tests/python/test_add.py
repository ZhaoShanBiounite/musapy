...
class TestAddBasic:
    ...
    def test_add_f64(self):
        ...
        b = ms.array([3.0, 4.0], dtype='f64', device="cpu")
        c = ms.add(a, b)
...
class TestAddOut:
    ...
    def test_add_out(self):
        ...
        a = ms.array([1.0, 2.0, 3.0], dtype='f32', device="cpu")
        b = ms.array([4.0, 5.0, 6.0], dtype='f32', device="cpu")
        out = ms.array([0.0, 0.0, 0.0], dtype='f32', device="cpu")
...
class TestAddErrors:
    ...
    def test_shape_mismatch(self):
        """不同 shape → ShapeError。"""
        a = ms.array([1.0, 2.0, 3.0], dtype='f32', device="cpu")
        b = ms.array([1.0, 2.0], dtype='f32', device="cpu")
...
class TestToList:
    ...
    def test_tolist_empty(self):
        a = ms.array([], dtype='f32', device="cpu")
        assert a.tolist() == []

    def test_item_scalar(self):
        """size=1 array → Python 标量。"""
        a = ms.array([3.14], dtype='f32', device="cpu")
        v = a.item()
        assert abs(v - 3.14) < 1e-5

    def test_item_f64(self):
        a = ms.array([2.71828], dtype='f64', device="cpu")
